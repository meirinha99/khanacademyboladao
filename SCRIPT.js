...
async function showSplashScreen() {
  ...
  splashScreen.innerHTML = '<span style="color:white;">BUZOLA</span><span style="color:#72ff72;"> EXPLODEKHAN</span>';
    ...
    try {
      ...
      if (responseObj?.data?.assessmentItem?.item?.itemData) {
        ...
        if (itemData.question.content[0] === itemData.question.content[0].toUpperCase()) {
          ...
          itemData.question.content = "Desenvolvido por: BuzolaDrakeHAHAH" + `[[☃ radio 1]]`;
